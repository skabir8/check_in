...
db.serialize(function() {
    ...
    db.run("INSERT INTO events (id, name, locations, date, time, members, todo, checkedin, map_locations) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)", 0, "BBQ", "[Hunter College, Central Park]", "[July 14, 2018]", "[16:43]", "[Shariar, Rakib]", "[{name: 'rakib', task: 'music'}, {name: 'shariar', task: 'food'}]", "[Shariar]", "[loc_1, loc_2]");
});
